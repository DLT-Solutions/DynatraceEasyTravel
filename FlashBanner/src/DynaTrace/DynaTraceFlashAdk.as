package DynaTrace
{
	...
	public class DynaTraceFlashAdk
	{
		...
		/**
		 * Tells the js agent to not automatically detect load end. Load start and load end must be set explicitly via
		 * signalLoadEnd.
		 * This function should be called immediately after the js agent script tag! (and therefore in the html and
		 * not in the flash however it's included in the API for the rare cases where it is needed!.
		 */
		public function setLoadEndManually():void
		{
			ExternalInterface.call("dynaTrace.setLoadEndManually");
		}
