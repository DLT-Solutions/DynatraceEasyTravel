...
public class WebserverAgentControlProcedureTest {

	@Test
	public void testWebserverAgentRestartProcedure() throws Exception {
		WebserverAgentControlProcedure proc = new WebserverAgentControlProcedure(new DefaultProcedureMapping(Constants.Procedures.WEBSERVER_AGENT_RESTART_ID));
	...
	@Test
	public void testWebserverAgentRestartProcedureStopTwice() {
		WebserverAgentControlProcedure proc = new WebserverAgentControlProcedure(new DefaultProcedureMapping(Constants.Procedures.WEBSERVER_AGENT_RESTART_ID));
	...
	@Test
	public void testWebserverAgentStartWithServiceStarted() throws Exception {
		WebserverAgentControlProcedure proc = new WebserverAgentControlProcedure(new DefaultProcedureMapping(Constants.Procedures.WEBSERVER_AGENT_RESTART_ID));
		WebserverAgentControlProcedure proc2 = new WebserverAgentControlProcedure(new DefaultProcedureMapping(Constants.Procedures.WEBSERVER_AGENT_RESTART_ID));
