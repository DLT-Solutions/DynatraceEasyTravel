...
public class HeadlessAngularSpecialUserVisitScenario extends HeadlessAngularOneVisitScenario {
	@Override
	public Simulator createSimulator() { return new HeadlessAngularSimulator(this); }

	@Override
	protected String getName() {
		return ScenarioNames.HEADLESS_ANGULAR_SPECIAL_USER_VISIT;
	}

	@Override
	protected Visit createVisitForHost(String host) {
		return new HeadlessAngularConvertedVisit(host);
	}
